 ...
 */
final class Version20230615101041 extends AbstractMigration
{
    public function getDescription(): string
    {
        return '[User] Add birth date.';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE user ADD COLUMN birthdate DATETIME DEFAULT NULL');
    }
